---
name: ai-agent-cli-guide
description: AI CLI Agent 实用指南：CLI Agent 设计原则、工具对比（Claude Code / Codex / OpenCode）、文件响应模式、AI 调用 AI。Use when 设计或调用 CLI agent。
---
...
**Python 客户端**: 自行实现 API 封装，覆盖 create_session / send_message / get_session_messages / wait_for_session_complete 等常用操作。
